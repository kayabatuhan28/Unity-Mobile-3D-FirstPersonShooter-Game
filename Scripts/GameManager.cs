...
public class GameManager : MonoBehaviour
{
    ...
    IEnumerator ItemSpawn()
    {
        for (int i = 0; i < amountToSpawn; i++)
        {
            ...
            int ID = Random.Range(0, itemType.Length - 1);
    ...
    public void SpawnLootOnEnemyDead(Transform EnemyPosition)
    {
        ...
        _ItemManager[0]._Item[spawnPointIndex].ItemID = ID;
        ...
        itemObjectPool[spawnPointIndex].GetComponent<ItemBox>().ListID = spawnPointIndex;
        itemObjectPool[spawnPointIndex].SetActive(true);
